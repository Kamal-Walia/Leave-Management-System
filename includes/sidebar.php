	 ...
	 $dp;
$eid=$_SESSION['eid'];
$sql = "SELECT FirstName,LastName,EmpId,Gender from  tblemployees where EmpId=:eid";
...
$dp="profile-image.png";
else
$dp="profile-imagef.png";	
?>
                ...
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        <div class="sidebar-profile-image">
                            ...
                            <img src="assets/images/<?php echo htmlentities($dp)?>" class="circle" alt="">
                        </div>
...
{               ?>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="myprofile.php"><i class="material-icons">account_box</i>My Profile</a></li>
				...
				<li class="no-padding"><a class="waves-effect waves-grey" href="updateprofile.php"><i class="material-icons">account_box</i>Update Profile</a></li>
