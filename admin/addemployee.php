...
$status=1;
$sql1="Select DepartmentCode from tbldepartments where DepartmentName=:department";
...
foreach($result as $r)
{ 
$dcode=$r->DepartmentCode;
}
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,DepartmentCode,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:result,:address,:city,:country,:mobileno,:status)";
...
$query->bindParam(':result',$dcode,PDO::PARAM_STR);
...
<input id="firstName" name="firstName" type="text" pattern="[a-zA-Z]+" required>
</div>

<div class="input-field col m6 s12">
<label for="lastName">Last name</label>
<input id="lastName" name="lastName" type="text" autocomplete="off" pattern="[a-zA-Z]+" required>
</div>
