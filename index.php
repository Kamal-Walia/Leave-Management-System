...
$sql ="SELECT EmailId,Password,Status,Empid FROM tblemployees WHERE EmailId=:uname and Password=:password";
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons">account_box</i>Login</a></li>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               <div class="input-field col s12">
                                                   <input id="username" type="email" name="username" class="validate" autocomplete="off" required >
